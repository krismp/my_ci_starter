...
<div class="col-xs-5">
	...
	<div class="panel panel-default">
	    <div class="panel-heading">
	        <div class="row">
	    		<div class="col-xs-6">
		        	<strong class="pull-left"><?php echo $trains->jenis_penumpang; ?></strong>
		        </div>
	    		<div class="col-xs-6">
		        	<a href="<?php echo site_url('admin/penumpang/edit/'.$trains->id) ?>" class="pull-right btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
		        </div>
	    	</div>
	    </div>
