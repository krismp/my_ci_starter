...
dateFormat.masks = {
    ...
    advediaDate:      "dd/mm/yyyy",
    advediaTime:      "HH:MM:ss"
};
    ...
    var xn = {
        ...
        helper: {
            ...
            stylize: function(selector) {
                ...
                $(selector).find('span[title]').tooltip();
...
function timer() {
    ...
    $('.advedia-time').html(t.format('advediaTime'));
    $('.advedia-date').html(t.format('advediaDate'));
}
